<template>
	<view class="my-evaluations-container">
		<!-- 导航菜单 -->
		<view class="nav-menu">
			<view 
				class="nav-item" 
		...
		<view class="evaluations-section">
			<text class="section-title">我的评教记录</text>
			...
			<view class="empty-state" v-else>
				...
				<text class="empty-hint">快去提交你的第一份评教吧</text>
			</view>
		</view>
